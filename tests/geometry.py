...
assert Point(-20, -20).distance_to_point(Point(0,
                                               0)) == math.sqrt(20**2 + 20**2)
assert Point(0, 0).distance_to_point(Point(-20,
                                           -20)) == math.sqrt(20**2 + 20**2)

# --- Area of triangle
assert triangle_area_at_points(Point(0, 0), Point(0, 0), Point(0, 0)) == 0
assert round(
    triangle_area_at_points(Point(0, 0), Point(1, 1), Point(1, 0)),
    2) == round(0.5, 2)
assert round(
    triangle_area_at_points(Point(0, 0), Point(1, 2), Point(1, 0)),
    2) == round(1, 2)
